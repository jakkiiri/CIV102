...
legend("Max Bending Moment (Nmm)", "Fail Tension")
...
legend("Max Bending Moment (Nmm)", "Fail Compression")
...
legend("Max Bending Moment (Nmm)", "Fail Buckling")
...
legend("Max Bending Moment (Nmm)", "Fail Shear")
...
legend("Max Bending Moment (Nmm)", "Fail Shear Glue")
...
legend("Max Bending Moment (Nmm)", "Fail Shear Buckling")
%%
